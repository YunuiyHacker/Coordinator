...
class GetNotificationByTagOperator(private val notificationDao: NotificationDao) {
    suspend operator fun invoke(tag: String): Notification {
        return notificationDao.getNotificationByTag(tag)
    }
}